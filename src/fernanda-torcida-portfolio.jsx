  ...
  return (
    <div style={{ background: C.canvas, color: C.ink, fontFamily: FONT.body, overflowX: "hidden" }}>
      ...
      <section id="hero" style={{
        ...
        {/* Atmospheric orbs */}
        <div style={{ position: "absolute", top: "12%", right: "8%", width: 320, height: 320, background: `radial-gradient(circle, ${C.gradientMint}70 0%, transparent 70%)`, zIndex: 2, pointerEvents: "none", animation: "orbFloat1 8s ease-in-out infinite" }} />
        <div style={{ position: "absolute", top: "35%", left: "4%", width: 240, height: 240, background: `radial-gradient(circle, ${C.gradientLavender}65 0%, transparent 70%)`, zIndex: 2, pointerEvents: "none", animation: "orbFloat2 10s ease-in-out infinite" }} />
...
const CSS = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  @keyframes orbFloat1 {
    ...
    50%  { transform: translate(-55vw, 25vh); }
